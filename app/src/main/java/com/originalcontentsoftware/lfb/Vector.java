...
public class Vector
{
  ...
  public void setVector( float tx, float ty, float tz )
  {
    x = tx; y = ty; z = tz;
  }
  ...
  public void crossProduct ( Vector d1, Vector d2 )
  {
  ...
  public float getScaler(Vector vector)
  {
    Vector t = new Vector();
  ...
  public float getDistance( Vector t )
  {
    float dx = t.x - x;
    float dy = t.y - y;
    float dz = t.z - z;
  ...
  public void rotateVector( Matrix M, Vector V )
  {
  ...
  public void calcNorm( Vector p1, Vector p2, Vector p3 )
  {
  ...
  public void transformVector( Matrix m, Vector v )
  {
    float h;
  ...
  public void average( Vector a, Vector b )
  {
    x = a.x + b.x;
    y = a.y + b.y;
    z = a.z + b.z;
  ...
  public boolean intersectBox( Vector rayPosition, Vector collisionBox[], float extend )
  {
